    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-5">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;"> Add Medicine</h5>
                ...
                <div class="col-lg-8">
                    ...
                    <form name="myform" action="" method="post" onsubmit="return validate()">
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary py-3 px-5" type="submit" name="submit" id="sendMessageButton">Add</button>
                            </div>
